 ...
 */
  onLoad: function (options) {
    ...
    var url = 'https://www.heshenghaoche.com/oms/api.php/wxVideo/videoPlay?admin=1&id=' + options.id + '&userid=' + options.userid + '&usertype=' + usertype + '&userId=' + userId+'&myuserid=' + myuserid+ '&index=' + options.index + '&title='+options.title;
    console.log(url);
